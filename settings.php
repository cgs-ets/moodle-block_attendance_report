...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('block_attendance_report/dbattbytermbyidprimary', get_string('dbattbytermbyidprimary', 'block_attendance_report'), get_string('dbattbytermbyidprimary_desc', 'block_attendance_report'), ''));
